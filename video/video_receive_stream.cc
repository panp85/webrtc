...
VideoCodec CreateDecoderVideoCodec(const VideoReceiveStream::Decoder& decoder) {
  ...
  ALOGE_PP("ppt, in CreateDecoderVideoCodec, codec.plType = %d, codec.codecType = %d.\n", codec.codecType, codec.plType);
...
VideoReceiveStream::VideoReceiveStream(
  ...
  ALOGI("ppt, in VideoReceiveStream::VideoReceiveStream, go to CreateReceiver 1.\n");
  media_receiver_ = receiver_controller->CreateReceiver(
      config_.rtp.remote_ssrc, &rtp_video_stream_receiver_);
  if (config_.rtp.rtx_ssrc) {
  	ALOGI("ppt, in VideoReceiveStream::VideoReceiveStream, go to CreateReceiver 2.\n");
...
void VideoReceiveStream::Start() {
  ...
  if (config_.renderer) {
    if (config_.disable_prerenderer_smoothing) {
      ALOGE_PP("ppt, in VideoReceiveStream::Start, renderer = this.\n");
      renderer = this;
    } else {
	  ALOGE_PP("ppt, in VideoReceiveStream::Start, renderer = IncomingVideoStream.\n");
...
void VideoReceiveStream::RequestKeyFrame() {
  ALOGI("ppt, in VideoReceiveStream::RequestKeyFrame, go to rtp_video_stream_receiver_.RequestKeyFrame.\n");
...
void VideoReceiveStream::OnCompleteFrame(
  ...
  ALOGI("ppt, in VideoReceiveStream::OnCompleteFrame, go to InsertFrame.\n");
