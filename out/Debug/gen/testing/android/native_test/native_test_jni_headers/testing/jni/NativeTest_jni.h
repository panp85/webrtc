...
JNI_REGISTRATION_EXPORT extern const char kClassPath_org_chromium_native_1test_NativeTest[];
const char kClassPath_org_chromium_native_1test_NativeTest[] =
    "org/chromium/native_test/NativeTest";
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_native_1test_NativeTest_clazz = 0;
...
inline jclass org_chromium_native_1test_NativeTest_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_chromium_native_1test_NativeTest,
...
static void JNI_NativeTest_RunTests(JNIEnv* env, const base::android::JavaParamRef<jobject>&
    jcaller,
...
JNI_GENERATOR_EXPORT void Java_org_chromium_native_1test_NativeTest_nativeRunTests(
    JNIEnv* env,
    jobject jcaller,
    ...
    jobject appContext,
    jstring testDataDir) {
  return JNI_NativeTest_RunTests(env, base::android::JavaParamRef<jobject>(env, jcaller),
