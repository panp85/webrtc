...
webrtc::AudioReceiveStream* Call::CreateAudioReceiveStream(
  ...
  event_log_->Log(rtc::MakeUnique<RtcEventAudioReceiveStreamConfig>(
      CreateRtcLogStreamConfig(config)));
  ALOGI("ppt, in Call::CreateAudioReceiveStream, go to new AudioReceiveStream.\n");
...
webrtc::VideoReceiveStream* Call::CreateVideoReceiveStream(
  ...
  RTC_DCHECK_CALLED_SEQUENTIALLY(&configuration_sequence_checker_);
  ALOGI("ppt, in Call::CreateVideoReceiveStream, go to new VideoReceiveStream.\n");
...
PacketReceiver::DeliveryStatus Call::DeliverRtp(MediaType media_type,
  ...
  ALOGI("ppt, in Call::DeliverRtp, go to video_receiver_controller_ or audio_receiver_controller_.OnRtpPacket.\n");
