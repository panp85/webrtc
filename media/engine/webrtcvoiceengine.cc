...
class WebRtcVoiceMediaChannel::WebRtcAudioSendStream
 ...
 public:
  ...
  void SetSource(AudioSource* source) {
	...
	ALOGE_PP("ppt, in SetSource WebRtcAudioSendStream, go to SetSink.\n");
    source->SetSink(this);
    source_ = source;
    UpdateSendState();
  }
...
class WebRtcVoiceMediaChannel::WebRtcAudioReceiveStream {
 public:
  ...
  void SetRawAudioSink(std::unique_ptr<webrtc::AudioSinkInterface> sink) {
    ...
    ALOGE_PP("ppt, in SetRawAudioSink, go to SetSink.\n");
 ...
 private:
  void RecreateAudioReceiveStream() {
    ...
    SetPlayout(playout_);
	ALOGE_PP("ppt, in RecreateAudioReceiveStream, go to SetSink.\n");
...
void WebRtcVoiceMediaChannel::OnPacketReceived(
  ...
  ALOGI("ppt, in WebRtcVoiceMediaChannel::OnPacketReceived, go to AddRecvStream.\n");
  if (!AddRecvStream(sp)) {
