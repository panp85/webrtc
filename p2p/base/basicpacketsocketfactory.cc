...
//#define ALOGI(...) __android_log_print(ANDROID_LOG_INFO, "logcat basicpacketfactory.cc", __VA_ARGS__)
...
AsyncPacketSocket* BasicPacketSocketFactory::CreateUdpSocket(
  ...
  ALOGI("ppt, in BasicPacketSocketFactory::CreateUdpSocket, go to BindSocket.\n");
...
AsyncPacketSocket* BasicPacketSocketFactory::CreateClientTcpSocket(
  ...
  ALOGI("ppt, in BasicPacketSocketFactory::CreateClientTcpSocket, go to BindSocket.\n"); 
...
int BasicPacketSocketFactory::BindSocket(AsyncSocket* socket,
                                         ...
                                         uint16_t max_port) {
  int ret = -1;
  ALOGI("ppt, in BasicPacketSocketFactory::BindSocket, min_port, max_port: %d, %d.\n", min_port, max_port);
