...
FlexfecReceiveStreamImpl::FlexfecReceiveStreamImpl(
  ...
  // problem too.
  ALOGI("ppt, in FlexfecReceiveStreamImpl::FlexfecReceiveStreamImpl, go to receiver_controller->CreateReceiver.\n");
...
void FlexfecReceiveStreamImpl::OnRtpPacket(const RtpPacketReceived& packet) {
  if (!receiver_)
    return;
  ALOGI("ppt, in FlexfecReceiveStreamImpl::OnRtpPacket, go to channel_->OnRtpPacket.\n");
