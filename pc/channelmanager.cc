...
VoiceChannel* ChannelManager::CreateVoiceChannel(
  ...
  auto voice_channel = rtc::MakeUnique<VoiceChannel>(
      ...
      crypto_options);
  RTC_LOG(LS_ERROR) << "ppt, in ChannelManager::CreateVoiceChannel, go to voice_channel->Init_w";
...
VideoChannel* ChannelManager::CreateVideoChannel(
  ...
  if (!worker_thread_->IsCurrent()) {
  	ALOGI("ppt, in ChannelManager::CreateVideoChannel, go to CreateVideoChannel 1.\n");
  ...
  ALOGI("ppt, in ChannelManager::CreateVideoChannel, go to CreateVideoChannel 2.\n");
  ...
  auto video_channel = rtc::MakeUnique<VideoChannel>(
      ...
      rtc::WrapUnique(media_channel), content_name, srtp_required,
      crypto_options);
  RTC_LOG(LS_ERROR) << "ppt, in ChannelManager::CreateVideoChannel, go to video_channel->Init_w";
...
RtpDataChannel* ChannelManager::CreateRtpDataChannel(
  ...
  auto data_channel = rtc::MakeUnique<RtpDataChannel>(
      ...
      rtc::WrapUnique(media_channel), content_name, srtp_required,
      crypto_options);
  RTC_LOG(LS_ERROR) << "ppt, in ChannelManager::CreateRtpDataChannel, go to data_channel->Init_w";
