...
VideoSendStream* DegradedCall::CreateVideoSendStream(
  ...
  ++num_send_streams_;
  RTC_LOG(LS_ERROR) << "ppt, in DegradedCall::CreateVideoSendStream 1, go to call_->CreateVideoSendStream.\n";
...
VideoSendStream* DegradedCall::CreateVideoSendStream(
  ...
  ++num_send_streams_;
  RTC_LOG(LS_ERROR) << "ppt, in DegradedCall::CreateVideoSendStream 2, go to call_->CreateVideoSendStream.\n";
