...
JNI_REGISTRATION_EXPORT extern const char kClassPath_org_webrtc_EglBase14_00024Context[];
const char kClassPath_org_webrtc_EglBase14_00024Context[] = "org/webrtc/EglBase14$Context";
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_EglBase14_clazz = 0;
...
#endif
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_EglBase14_00024Context_clazz = 0;
...
inline jclass org_webrtc_EglBase14_00024Context_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_webrtc_EglBase14_00024Context,
...
static base::subtle::AtomicWord g_org_webrtc_EglBase14_00024Context_isEgl14Context = 0;
static jboolean Java_Context_isEgl14Context(JNIEnv* env, const base::android::JavaRef<jobject>&
    context) {
