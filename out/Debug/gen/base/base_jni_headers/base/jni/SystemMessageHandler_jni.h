...
JNI_REGISTRATION_EXPORT extern const char kClassPath_org_chromium_base_SystemMessageHandler[];
const char kClassPath_org_chromium_base_SystemMessageHandler[] =
    "org/chromium/base/SystemMessageHandler";
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_base_SystemMessageHandler_clazz = 0;
...
inline jclass org_chromium_base_SystemMessageHandler_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_chromium_base_SystemMessageHandler,
...
JNI_GENERATOR_EXPORT void Java_org_chromium_base_SystemMessageHandler_nativeDoRunLoopOnce(
    JNIEnv* env,
    jobject jcaller,
    jlong nativeMessagePumpForUI,
    jboolean delayed) {
  MessagePumpForUI* native = reinterpret_cast<MessagePumpForUI*>(nativeMessagePumpForUI);
  CHECK_NATIVE_PTR(env, jcaller, native, "DoRunLoopOnce");
  return native->DoRunLoopOnce(env, base::android::JavaParamRef<jobject>(env, jcaller), delayed);
}

JNI_GENERATOR_EXPORT void Java_org_chromium_base_SystemMessageHandler_nativeDoIdleWork(
    JNIEnv* env,
    jobject jcaller,
    jlong nativeMessagePumpForUI) {
  MessagePumpForUI* native = reinterpret_cast<MessagePumpForUI*>(nativeMessagePumpForUI);
  CHECK_NATIVE_PTR(env, jcaller, native, "DoIdleWork");
  return native->DoIdleWork(env, base::android::JavaParamRef<jobject>(env, jcaller));
}


static base::subtle::AtomicWord g_org_chromium_base_SystemMessageHandler_scheduleWork = 0;
...
static base::subtle::AtomicWord g_org_chromium_base_SystemMessageHandler_scheduleDelayedWork = 0;
...
static base::subtle::AtomicWord g_org_chromium_base_SystemMessageHandler_shutdown = 0;
static void Java_SystemMessageHandler_shutdown(JNIEnv* env, const base::android::JavaRef<jobject>&
    obj) {
  CHECK_CLAZZ(env, obj.obj(),
      org_chromium_base_SystemMessageHandler_clazz(env));
  jmethodID method_id = base::android::MethodID::LazyGet<
...
static base::subtle::AtomicWord g_org_chromium_base_SystemMessageHandler_create = 0;
static base::android::ScopedJavaLocalRef<jobject> Java_SystemMessageHandler_create(JNIEnv* env,
    jlong nativeMessagePumpForUI) {
  ...
  jmethodID method_id = base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_STATIC>(
          env, org_chromium_base_SystemMessageHandler_clazz(env),
          "create",
          "(J)Lorg/chromium/base/SystemMessageHandler;",
