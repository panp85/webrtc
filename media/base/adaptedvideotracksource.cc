...
void AdaptedVideoTrackSource::OnFrame(const webrtc::VideoFrame& frame) {
  ...
  if (apply_rotation() && frame.rotation() != webrtc::kVideoRotation_0 &&
      ...
      //RTC_LOG(LS_INFO) << 
	  //	"ppt, in AdaptedVideoTrackSource::OnFrame, apply_rotation, not kVideoRotation_0, type is kI420, "
	  //	<< "go to broadcaster_.OnFrame";
    ...
    broadcaster_.OnFrame(webrtc::VideoFrame(
  	...
  	//RTC_LOG(LS_INFO) << 
	//	"ppt, in AdaptedVideoTrackSource::OnFrame, nothing, go to broadcaster_.OnFrame";
...
void AdaptedVideoTrackSource::AddOrUpdateSink(
  ...
  RTC_LOG(LS_ERROR) << "ppt, AdaptedVideoTrackSource::AddOrUpdateSink, go to broadcaster_.AddOrUpdateSink.";
