...
bool RtpTransport::RegisterRtpDemuxerSink(const RtpDemuxerCriteria& criteria,
  ...
  ALOGI("ppt, in RtpTransport::RegisterRtpDemuxerSink, go to rtp_demuxer_.AddSink, sink: %p.\n", sink);
...
void RtpTransport::DemuxPacket(rtc::CopyOnWriteBuffer* packet,
  ...
  ALOGI("ppt, in RtpTransport::DemuxPacket, go to rtp_demuxer_->OnRtpPacket.\n");
...
void RtpTransport::OnRtpPacketReceived(rtc::CopyOnWriteBuffer* packet,
  ...
  ALOGI("ppt, in RtpTransport::OnRtpPacketReceived, go to DemuxPacket.\n");
  DemuxPacket(packet, packet_time);
}

void RtpTransport::OnRtcpPacketReceived(rtc::CopyOnWriteBuffer* packet,
                                        const rtc::PacketTime& packet_time) {
  ALOGI("ppt, in RtpTransport::OnRtcpPacketReceived, go to SignalRtcpPacketReceived.\n");
