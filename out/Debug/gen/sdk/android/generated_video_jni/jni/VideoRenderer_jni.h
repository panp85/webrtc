...
JNI_REGISTRATION_EXPORT extern const char kClassPath_org_webrtc_VideoRenderer_00024I420Frame[];
const char kClassPath_org_webrtc_VideoRenderer_00024I420Frame[] =
    "org/webrtc/VideoRenderer$I420Frame";

JNI_REGISTRATION_EXPORT extern const char kClassPath_org_webrtc_VideoRenderer_00024Callbacks[];
const char kClassPath_org_webrtc_VideoRenderer_00024Callbacks[] =
    "org/webrtc/VideoRenderer$Callbacks";
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_VideoRenderer_clazz = 0;
...
#endif
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_VideoRenderer_00024I420Frame_clazz =
    0;
...
inline jclass org_webrtc_VideoRenderer_00024I420Frame_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_webrtc_VideoRenderer_00024I420Frame,
      &g_org_webrtc_VideoRenderer_00024I420Frame_clazz);
}
#endif
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_VideoRenderer_00024Callbacks_clazz =
    0;
...
inline jclass org_webrtc_VideoRenderer_00024Callbacks_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_webrtc_VideoRenderer_00024Callbacks,
...
JNI_GENERATOR_EXPORT jlong Java_org_webrtc_VideoRenderer_nativeCreateVideoRenderer(
    JNIEnv* env,
    jclass jcaller,
    jobject callbacks) {
  return JNI_VideoRenderer_CreateVideoRenderer(env, base::android::JavaParamRef<jclass>(env,
      jcaller), base::android::JavaParamRef<jobject>(env, callbacks));
}
...
JNI_GENERATOR_EXPORT void Java_org_webrtc_VideoRenderer_nativeFreeWrappedVideoRenderer(
    JNIEnv* env,
    jclass jcaller,
    jlong videoRenderer) {
  return JNI_VideoRenderer_FreeWrappedVideoRenderer(env, base::android::JavaParamRef<jclass>(env,
      jcaller), videoRenderer);
}

static void JNI_VideoRenderer_ReleaseFrame(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    jlong framePointer);

JNI_GENERATOR_EXPORT void Java_org_webrtc_VideoRenderer_nativeReleaseFrame(
    JNIEnv* env,
    jclass jcaller,
    jlong framePointer) {
  return JNI_VideoRenderer_ReleaseFrame(env, base::android::JavaParamRef<jclass>(env, jcaller),
      framePointer);
}


static base::subtle::AtomicWord g_org_webrtc_VideoRenderer_00024I420Frame_Constructor = 0;
static base::android::ScopedJavaLocalRef<jobject> Java_I420Frame_Constructor(JNIEnv* env,
  ...
  jmethodID method_id = base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          "<init>",
          "(ILorg/webrtc/VideoFrame$Buffer;J)V",
...
static base::subtle::AtomicWord g_org_webrtc_VideoRenderer_00024I420Frame_createI420Frame = 0;
static base::android::ScopedJavaLocalRef<jobject> Java_I420Frame_createI420Frame(JNIEnv* env,
    JniIntWrapper width,
  ...
  jmethodID method_id = base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_STATIC>(
          env, org_webrtc_VideoRenderer_00024I420Frame_clazz(env),
          "createI420Frame",
"(IIIILjava/nio/ByteBuffer;ILjava/nio/ByteBuffer;ILjava/nio/ByteBuffer;J)Lorg/webrtc/VideoRenderer$I420Frame;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(org_webrtc_VideoRenderer_00024I420Frame_clazz(env),
          method_id, as_jint(width), as_jint(height), as_jint(rotationDegree), as_jint(y_stride),
              y_buffer.obj(), as_jint(u_stride), u_buffer.obj(), as_jint(v_stride), v_buffer.obj(),
              nativeFramePointer);
  jni_generator::CheckException(env);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}

static base::subtle::AtomicWord g_org_webrtc_VideoRenderer_00024Callbacks_renderFrame = 0;
static void Java_Callbacks_renderFrame(JNIEnv* env, const base::android::JavaRef<jobject>& obj,
