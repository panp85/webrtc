...
JNI_REGISTRATION_EXPORT extern const char kClassPath_org_chromium_native_1test_MainRunner[];
const char kClassPath_org_chromium_native_1test_MainRunner[] =
    "org/chromium/native_test/MainRunner";
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_native_1test_MainRunner_clazz = 0;
...
inline jclass org_chromium_native_1test_MainRunner_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_chromium_native_1test_MainRunner,
...
static jint JNI_MainRunner_RunMain(JNIEnv* env, const base::android::JavaParamRef<jclass>& jcaller,
    const base::android::JavaParamRef<jobjectArray>& commandLine);

JNI_GENERATOR_EXPORT jint Java_org_chromium_native_1test_MainRunner_nativeRunMain(
    JNIEnv* env,
    jclass jcaller,
    jobjectArray commandLine) {
  return JNI_MainRunner_RunMain(env, base::android::JavaParamRef<jclass>(env, jcaller),
