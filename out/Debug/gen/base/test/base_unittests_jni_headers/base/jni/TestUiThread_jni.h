...
JNI_REGISTRATION_EXPORT extern const char kClassPath_org_chromium_base_TestUiThread[];
const char kClassPath_org_chromium_base_TestUiThread[] = "org/chromium/base/TestUiThread";
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_base_TestUiThread_clazz = 0;
...
inline jclass org_chromium_base_TestUiThread_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_chromium_base_TestUiThread,
