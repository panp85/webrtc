...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_base_TimezoneUtils_clazz = 0;
...
static base::subtle::AtomicWord g_org_chromium_base_TimezoneUtils_getDefaultTimeZoneId = 0;
