...
JNI_REGISTRATION_EXPORT extern const char kClassPath_org_webrtc_WrappedNativeVideoEncoder[];
const char kClassPath_org_webrtc_WrappedNativeVideoEncoder[] =
    "org/webrtc/WrappedNativeVideoEncoder";
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_WrappedNativeVideoEncoder_clazz = 0;
...
inline jclass org_webrtc_WrappedNativeVideoEncoder_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_webrtc_WrappedNativeVideoEncoder,
...
static base::subtle::AtomicWord g_org_webrtc_WrappedNativeVideoEncoder_createNativeEncoder = 0;
static jlong Java_WrappedNativeVideoEncoder_createNativeEncoder(JNIEnv* env, const
...
static base::subtle::AtomicWord g_org_webrtc_WrappedNativeVideoEncoder_isWrappedSoftwareEncoder = 0;
static jboolean Java_WrappedNativeVideoEncoder_isWrappedSoftwareEncoder(JNIEnv* env, const
...
static base::subtle::AtomicWord g_org_webrtc_WrappedNativeVideoEncoder_isInstanceOf = 0;
