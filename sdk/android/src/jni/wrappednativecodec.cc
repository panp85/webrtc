...
std::unique_ptr<VideoEncoder> JavaToNativeVideoEncoder(
  ...
  if (Java_WrappedNativeVideoEncoder_isInstanceOf(jni, j_encoder)) {
  	RTC_LOG(LS_ERROR) << "ppt, in JavaToNativeVideoEncoder, Java_WrappedNativeVideoEncoder_isInstanceOf yes.";
    ...
    encoder = reinterpret_cast<VideoEncoder*>(native_encoder);
  	...
  	RTC_LOG(LS_ERROR) << "ppt, in JavaToNativeVideoEncoder, Java_WrappedNativeVideoEncoder_isInstanceOf no,"
		<< " go to new VideoEncoderWrapper.\n";
