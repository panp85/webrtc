...
class BuiltinVideoEncoderFactory : public VideoEncoderFactory {
 public:
  ...
  std::unique_ptr<VideoEncoder> CreateVideoEncoder(
      ...
      RTC_LOG(LS_ERROR) << "ppt, in BuiltinVideoEncoderFactory CreateVideoEncoder.";
  ...
  std::vector<SdpVideoFormat> GetSupportedFormats() const override {
    ALOGI("ppt, in GetSupportedFormats BuiltinVideoEncoderFactory, go to GetSupportedFormats.\n");
