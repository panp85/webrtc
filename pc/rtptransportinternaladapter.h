...
class RtpTransportInternalAdapter : public RtpTransportInternal {
 public:
  ...
  void SetRtpPacketTransport(rtc::PacketTransportInternal* rtp) override {
    RTC_LOG(LS_ERROR) << "ppt, in SetRtpPacketTransport rtptransportinternaladapter.h, go to SetRtpPacketTransport.";
  ...
  bool RegisterRtpDemuxerSink(const RtpDemuxerCriteria& criteria,
    ...
    ALOGI("ppt, in RegisterRtpDemuxerSink rtptransportinternaladapter.h, go to transport_->RegisterRtpDemuxerSink.\n");
