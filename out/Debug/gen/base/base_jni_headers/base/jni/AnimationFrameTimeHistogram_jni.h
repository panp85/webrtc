...
inline jclass org_chromium_base_AnimationFrameTimeHistogram_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_chromium_base_AnimationFrameTimeHistogram,
...
JNI_GENERATOR_EXPORT void Java_org_chromium_base_AnimationFrameTimeHistogram_nativeSaveHistogram(
    JNIEnv* env,
    jobject jcaller,
  ...
  return JNI_AnimationFrameTimeHistogram_SaveHistogram(env,
      ...
      histogramName), base::android::JavaParamRef<jlongArray>(env, frameTimesMs), count);
}
