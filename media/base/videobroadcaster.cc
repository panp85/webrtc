...
#define ALOGI(...) __android_log_print(ANDROID_LOG_INFO, "logcat videobroadcaster.cc", __VA_ARGS__)
...
void VideoBroadcaster::AddOrUpdateSink(
  ...
  ALOGI("ppt, in VideoBroadcaster::AddOrUpdateSink, go in.\n");
...
void VideoBroadcaster::OnFrame(const webrtc::VideoFrame& frame) {
  ...
  for (auto& sink_pair : sink_pairs()) {
  	//RTC_LOG(LS_ERROR) << "ppt, in VideoBroadcaster::OnFrame, index = " << i++ ;
