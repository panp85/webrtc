...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_base_JavaExceptionReporter_clazz =
    0;
...
JNI_GENERATOR_EXPORT void Java_org_chromium_base_JavaExceptionReporter_nativeReportJavaException(
    ...
    jboolean crashAfterReport,
    jthrowable e) {
  return JNI_JavaExceptionReporter_ReportJavaException(env, base::android::JavaParamRef<jclass>(env,
      jcaller), crashAfterReport, base::android::JavaParamRef<jthrowable>(env, e));
}
...
static base::subtle::AtomicWord g_org_chromium_base_JavaExceptionReporter_installHandler = 0;
