...
AsyncUDPSocket* AsyncUDPSocket::Create(
   ...
   ALOGI("ppt, in AsyncUDPSocket::Create 1, go to new AsyncUDPSocket.\n");
...
AsyncUDPSocket* AsyncUDPSocket::Create(SocketFactory* factory,
                                       const SocketAddress& bind_address) {
  ALOGI("ppt, in AsyncUDPSocket::Create 2, go to factory->CreateAsyncSocket.\n");
  AsyncSocket* socket =
...
AsyncUDPSocket::AsyncUDPSocket(AsyncSocket* socket)
  ...
  size_ = BUF_SIZE;
  buf_ = new char[size_];
  ALOGI("ppt, in AsyncUDPSocket::AsyncUDPSocket, go in.\n");
...
void AsyncUDPSocket::OnReadEvent(AsyncSocket* socket) {
  ...
  ALOGI("ppt, in AsyncUDPSocket::OnReadEvent, go to SignalReadPacket, len = %d.\n", len);
  SignalReadPacket(
