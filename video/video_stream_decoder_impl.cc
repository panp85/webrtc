...
void VideoStreamDecoderImpl::OnFrame(
  ...
  ALOGI("ppt, in VideoStreamDecoderImpl::OnFrame, go to InsertFrame.\n");
...
VideoDecoder* VideoStreamDecoderImpl::GetDecoder(int payload_type) {
  ALOGE_PP("ppt, in VideoStreamDecoderImpl::GetDecoder, go in.\n");
  ...
  ALOGE_PP("ppt, in VideoStreamDecoderImpl::GetDecoder, go to InitDecode.\n");
