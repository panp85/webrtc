...
void VideoStreamEncoder::ReconfigureEncoder() {
  ...
  if (pending_encoder_creation_) {
	...
	RTC_LOG(LS_ERROR) << "ppt, in VideoStreamEncoder::ReconfigureEncoder, video_format: " << video_format.name;	
	...
	RTC_LOG(LS_ERROR) << "ppt, in VideoStreamEncoder::ReconfigureEncoder, go to video_sender_.RegisterExternalEncoder";
