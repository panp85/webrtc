...
class CricketToWebRtcEncoderFactory : public webrtc::VideoEncoderFactory {
 public:
  ...
  std::vector<webrtc::SdpVideoFormat> GetSupportedFormats() const override {
    ALOGI("ppt, in GetSupportedFormats CricketToWebRtcEncoderFactory, go in.\n");
    if (!external_encoder_factory_)
  ...
  std::unique_ptr<webrtc::VideoEncoder> CreateVideoEncoder(
      ...
      RTC_LOG(LS_ERROR) << "ppt, in CricketToWebRtcEncoderFactory CreateVideoEncoder.";
...
class EncoderAdapter : public webrtc::VideoEncoderFactory {
 public:
  ...
  std::unique_ptr<webrtc::VideoEncoder> CreateVideoEncoder(
      const webrtc::SdpVideoFormat& format) override {
      RTC_LOG(LS_ERROR) << "ppt, in EncoderAdapter CreateVideoEncoder.";
  ...
  std::vector<webrtc::SdpVideoFormat> GetSupportedFormats() const override {
    ALOGI("ppt, in GetSupportedFormats convert_legacy_video_factory, go in.\n");
    std::vector<webrtc::SdpVideoFormat> formats =
