...
bool VideoEncoderSoftwareFallbackWrapper::InitFallbackEncoder() {
  ...
  if (callback_)
  {
    RTC_LOG(LS_ERROR) << "ppt, in VideoEncoderSoftwareFallbackWrapper::InitFallbackEncoder, go to RegisterEncodeCompleteCallback.";
...
int32_t VideoEncoderSoftwareFallbackWrapper::InitEncode(
  ...
  if (ret == WEBRTC_VIDEO_CODEC_OK) {
    ...
    if (callback_)
    {
      RTC_LOG(LS_ERROR) << "ppt, in VideoEncoderSoftwareFallbackWrapper::InitEncode, go to RegisterEncodeCompleteCallback.";
...
int32_t VideoEncoderSoftwareFallbackWrapper::RegisterEncodeCompleteCallback(
  ...
  callback_ = callback;
  RTC_LOG(LS_ERROR) << "ppt, in VideoEncoderSoftwareFallbackWrapper::RegisterEncodeCompleteCallback, go to RegisterEncodeCompleteCallback 1.";
  int32_t ret = encoder_->RegisterEncodeCompleteCallback(callback);
  if (use_fallback_encoder_)
  {
    RTC_LOG(LS_ERROR) << "ppt, in VideoEncoderSoftwareFallbackWrapper::RegisterEncodeCompleteCallback, go to RegisterEncodeCompleteCallback 2.";
