...
JNI_REGISTRATION_EXPORT extern const char kClassPath_org_webrtc_WrappedNativeVideoDecoder[];
const char kClassPath_org_webrtc_WrappedNativeVideoDecoder[] =
    "org/webrtc/WrappedNativeVideoDecoder";
// Leaking this jclass as we cannot use LazyInstance from some threads.
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_webrtc_WrappedNativeVideoDecoder_clazz = 0;
...
inline jclass org_webrtc_WrappedNativeVideoDecoder_clazz(JNIEnv* env) {
  return base::android::LazyGetClass(env, kClassPath_org_webrtc_WrappedNativeVideoDecoder,
...
static base::subtle::AtomicWord g_org_webrtc_WrappedNativeVideoDecoder_createNativeDecoder = 0;
static jlong Java_WrappedNativeVideoDecoder_createNativeDecoder(JNIEnv* env, const
...
static base::subtle::AtomicWord g_org_webrtc_WrappedNativeVideoDecoder_isInstanceOf = 0;
