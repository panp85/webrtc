...
inline jclass org_chromium_base_process_1launcher_ChildProcessService_clazz(JNIEnv* env) {
...
JNI_GENERATOR_EXPORT void
    Java_org_chromium_base_process_1launcher_ChildProcessService_nativeRegisterFileDescriptors(
    JNIEnv* env,
    jclass jcaller,
    jobjectArray keys,
    jintArray id,
...
JNI_GENERATOR_EXPORT void
    Java_org_chromium_base_process_1launcher_ChildProcessService_nativeExitChildProcess(
    JNIEnv* env,
    jclass jcaller) {
  return JNI_ChildProcessService_ExitChildProcess(env, base::android::JavaParamRef<jclass>(env,
      jcaller));
}
