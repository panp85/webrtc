...
bool PeerConnectionWrapper::ExchangeOfferAnswerWith(
  ...
  ALOGI("ppt, in PeerConnectionWrapper::ExchangeOfferAnswerWith, go to answerer->SetRemoteDescription.\n");
...
rtc::scoped_refptr<RtpSenderInterface> PeerConnectionWrapper::AddTrack(
    ...
    RTC_LOG(LS_ERROR) << "ppt, in PeerConnectionWrapper::AddTrack, go to pc()->AddTrack";
...
rtc::scoped_refptr<RtpSenderInterface> PeerConnectionWrapper::AddAudioTrack(
    ...
    const std::vector<std::string>& stream_ids) {
    RTC_LOG(LS_ERROR) << "ppt, in PeerConnectionWrapper::AddAudioTrack, go to AddTrack";
...
rtc::scoped_refptr<RtpSenderInterface> PeerConnectionWrapper::AddVideoTrack(
    const std::string& track_label,
    const std::vector<std::string>& stream_ids) {
        RTC_LOG(LS_ERROR) << "ppt, in PeerConnectionWrapper::AddVideoTrack, go to AddTrack";
