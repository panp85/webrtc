...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_base_MemoryPressureListener_clazz =
    0;
...
JNI_GENERATOR_EXPORT void Java_org_chromium_base_MemoryPressureListener_nativeOnMemoryPressure(
    JNIEnv* env,
    jclass jcaller,
    jint pressure) {
  return JNI_MemoryPressureListener_OnMemoryPressure(env, base::android::JavaParamRef<jclass>(env,
      jcaller), pressure);
}


static base::subtle::AtomicWord g_org_chromium_base_MemoryPressureListener_addNativeCallback = 0;
