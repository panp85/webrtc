...
class DecoderFactoryAdapter {
 public:
  ...
  ALOGI("ppt, in DecoderFactoryAdapter::GetSupportedFormats, go in.\n");
...
class NullVideoDecoder : public webrtc::VideoDecoder {
 public:
  int32_t InitDecode(const webrtc::VideoCodec* codec_settings,
	...
	ALOGE_PP("ppt, in NullVideoDecoder::InitDecode, go in.\n");
...
std::vector<VideoCodec> AssignPayloadTypesAndDefaultCodecs(
  ...
  for (const webrtc::SdpVideoFormat& format : input_formats) {
    ...
    // we don't recognize?
    //if(codec.name)
        ALOGI("ppt, in AssignPayloadTypesAndDefaultCodecs, codec.name: %s.\n", codec.name.c_str());
...
std::vector<VideoCodec> AssignPayloadTypesAndDefaultCodecs(
  ...
  ALOGI("ppt, in AssignPayloadTypesAndDefaultCodecs 2, go in.\n");
...
UnsignalledSsrcHandler::Action DefaultUnsignalledSsrcHandler::OnUnsignalledSsrc(
  ...
  ALOGE_PP("ppt, in DefaultUnsignalledSsrcHandler::OnUnsignalledSsrc, go to SetSink.\n");
...
void DefaultUnsignalledSsrcHandler::SetDefaultSink(
  ...
  rtc::Optional<uint32_t> default_recv_ssrc =
      channel->GetDefaultReceiveStreamSsrc();
  if (default_recv_ssrc) {
  	ALOGE_PP("ppt, in DefaultUnsignalledSsrcHandler::SetDefaultSink, go to SetSink.\n");
...
WebRtcVideoChannel* WebRtcVideoEngine::CreateChannel(
  ...
  ALOGI("ppt, in WebRtcVideoEngine::CreateChannel, go in.\n");
...
std::vector<VideoCodec> WebRtcVideoEngine::codecs() const {
  ALOGI("ppt, in WebRtcVideoEngine::codecs, go to AssignPayloadTypesAndDefaultCodecs.\n");
...
WebRtcVideoChannel::WebRtcVideoChannel(
  ...
  sending_ = false;
  ALOGI("ppt, in WebRtcVideoChannel::WebRtcVideoChannel, go to AssignPayloadTypesAndDefaultCodecs.\n");
  recv_codecs_ =
...
WebRtcVideoChannel::SelectSendVideoCodec(
    ...
    ALOGI("ppt, in WebRtcVideoChannel::SelectSendVideoCodec, go to AssignPayloadTypesAndDefaultCodecs.\n");
...
bool WebRtcVideoChannel::GetChangedRecvParameters(
  ...
  ALOGI("ppt, in WebRtcVideoChannel::GetChangedRecvParameters, go to AssignPayloadTypesAndDefaultCodecs.\n");
...
bool WebRtcVideoChannel::AddRecvStream(const StreamParams& sp) {
  ALOGI("ppt, in WebRtcVideoChannel::AddRecvStream, go to AddRecvStream.\n");
...
bool WebRtcVideoChannel::AddRecvStream(const StreamParams& sp,
  ...
  ALOGE_PP("ppt, in WebRtcVideoChannel::AddRecvStream, go to new WebRtcVideoReceiveStream.\n");
...
bool WebRtcVideoChannel::SetSink(
  ...
  ALOGE_PP("ppt, in WebRtcVideoChannel::SetSink, go to SetSink.\n");
...
void WebRtcVideoChannel::WebRtcVideoSendStream::AddOrUpdateSink(
  ...
  ALOGI("ppt, in WebRtcVideoChannel::WebRtcVideoSendStream::AddOrUpdateSink, go in.\n");
...
void WebRtcVideoChannel::WebRtcVideoSendStream::RecreateWebRtcStream() {
  ...
  RTC_LOG(LS_ERROR) << "ppt, in WebRtcVideoChannel::WebRtcVideoSendStream::RecreateWebRtcStream, go to CreateVideoSendStream.\n";
...
WebRtcVideoChannel::WebRtcVideoReceiveStream::WebRtcVideoReceiveStream(
  ...
  ALOGE_PP("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::WebRtcVideoReceiveStream, go to ConfigureCodecs.\n");
  ConfigureCodecs(recv_codecs, &old_decoders);
  ConfigureFlexfecCodec(flexfec_config.payload_type);
  MaybeRecreateWebRtcFlexfecStream();
  ALOGI("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::WebRtcVideoReceiveStream, go to RecreateWebRtcVideoStream.\n");
...
void WebRtcVideoChannel::WebRtcVideoReceiveStream::ConfigureCodecs(
  ...
  ALOGE_PP("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::ConfigureCodecs, go in.\n");
  *old_decoders = std::move(allocated_decoders_);
  ...
  for (const auto& recv_codec : recv_codecs) {
	...
	ALOGE_PP("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::ConfigureCodecs, config_.decoders.push_back: %s, %d.\n", 
		recv_codec.codec.name.c_str(), decoder.payload_type);
...
void WebRtcVideoChannel::WebRtcVideoReceiveStream::SetLocalSsrc(
  ...
  RTC_LOG(LS_INFO)
      ...
      << local_ssrc;
  MaybeRecreateWebRtcFlexfecStream();
  ALOGI("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::SetLocalSsrc, go to RecreateWebRtcVideoStream.\n");
  RecreateWebRtcVideoStream();
}
...
void WebRtcVideoChannel::WebRtcVideoReceiveStream::SetFeedbackParameters(
  ...
  RTC_LOG(LS_INFO)
      ...
      << ", transport_cc=" << transport_cc_enabled;
  MaybeRecreateWebRtcFlexfecStream();
  ALOGI("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::SetFeedbackParameters, go to RecreateWebRtcVideoStream.\n");
  RecreateWebRtcVideoStream();
}
...
void WebRtcVideoChannel::WebRtcVideoReceiveStream::SetRecvParameters(
  ...
  if (params.codec_settings) {
  	ALOGE_PP("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::SetRecvParameters, go to ConfigureCodecs.\n");
  ...
  if (video_needs_recreation) {
  	ALOGI("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::SetRecvParameters, go to RecreateWebRtcVideoStream.\n");
    RTC_LOG(LS_INFO)
...
void WebRtcVideoChannel::WebRtcVideoReceiveStream::
  ...
  ALOGI("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::RecreateWebRtcVideoStream, go to call_->CreateVideoReceiveStream.\n");
...
void WebRtcVideoChannel::WebRtcVideoReceiveStream::SetSink(
    rtc::VideoSinkInterface<webrtc::VideoFrame>* sink) {
  ALOGE_PP("ppt, in WebRtcVideoChannel::WebRtcVideoReceiveStream::SetSink, go in.\n");
  rtc::CritScope crit(&sink_lock_);
  sink_ = sink;
}
