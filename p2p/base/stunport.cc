...
UDPPort::UDPPort(rtc::Thread* thread,
  ...
  RTC_LOG(LS_ERROR) << "ppt, in UDPPort::UDPPort, socket_";
...
bool UDPPort::Init() {
  ...
  if (!SharedSocket()) {
	...
	RTC_LOG(LS_ERROR) << "ppt, in UDPPort::Init, socket_";
...
Connection* UDPPort::CreateConnection(const Candidate& address,
  ...
  //RTC_LOG(LS_ERROR) << "ppt, in UDPPort::CreateConnection, Adding connection, " << " candidate: " << address.ToString();
...
bool UDPPort::HandleIncomingPacket(rtc::AsyncPacketSocket* socket,
  ...
  ALOGI("ppt, in UDPPort::HandleIncomingPacket, go to OnReadPacket.\n");
...
void UDPPort::OnReadPacket(rtc::AsyncPacketSocket* socket,
  ...
  if (Connection* conn = GetConnection(remote_addr)) {
    ...
    conn->OnReadPacket(data, size, packet_time);
  	...
  	ALOGI("ppt, in UDPPort::OnReadPacket, go to Port::OnReadPacket.\n");
