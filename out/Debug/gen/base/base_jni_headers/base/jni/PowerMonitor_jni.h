...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_base_PowerMonitor_clazz = 0;
...
JNI_GENERATOR_EXPORT void Java_org_chromium_base_PowerMonitor_nativeOnBatteryChargingChanged(
    JNIEnv* env,
    jclass jcaller) {
  return JNI_PowerMonitor_OnBatteryChargingChanged(env, base::android::JavaParamRef<jclass>(env,
      jcaller));
}


static base::subtle::AtomicWord g_org_chromium_base_PowerMonitor_isBatteryPower = 0;
