...
_NETEQNETWORKSTATISTICS.fields_by_name['packet_discard_rate'].has_options = True
_NETEQNETWORKSTATISTICS.fields_by_name['packet_discard_rate']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
