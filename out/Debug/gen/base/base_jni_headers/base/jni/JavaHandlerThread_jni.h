...
JNI_REGISTRATION_EXPORT base::subtle::AtomicWord g_org_chromium_base_JavaHandlerThread_clazz = 0;
...
JNI_GENERATOR_EXPORT void Java_org_chromium_base_JavaHandlerThread_nativeInitializeThread(
    JNIEnv* env,
    jobject jcaller,
  ...
  return native->InitializeThread(env, base::android::JavaParamRef<jobject>(env, jcaller),
      nativeEvent);
}

JNI_GENERATOR_EXPORT void Java_org_chromium_base_JavaHandlerThread_nativeStopThread(
    JNIEnv* env,
    jobject jcaller,
    jlong nativeJavaHandlerThread) {
  JavaHandlerThread* native = reinterpret_cast<JavaHandlerThread*>(nativeJavaHandlerThread);
  CHECK_NATIVE_PTR(env, jcaller, native, "StopThread");
  return native->StopThread(env, base::android::JavaParamRef<jobject>(env, jcaller));
}

JNI_GENERATOR_EXPORT void Java_org_chromium_base_JavaHandlerThread_nativeOnLooperStopped(
    JNIEnv* env,
    jobject jcaller,
    jlong nativeJavaHandlerThread) {
  JavaHandlerThread* native = reinterpret_cast<JavaHandlerThread*>(nativeJavaHandlerThread);
  CHECK_NATIVE_PTR(env, jcaller, native, "OnLooperStopped");
  return native->OnLooperStopped(env, base::android::JavaParamRef<jobject>(env, jcaller));
}


static base::subtle::AtomicWord g_org_chromium_base_JavaHandlerThread_create = 0;
static base::android::ScopedJavaLocalRef<jobject> Java_JavaHandlerThread_create(JNIEnv* env, const
  ...
  jmethodID method_id = base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_STATIC>(
          ...
          "create",
          "(Ljava/lang/String;)Lorg/chromium/base/JavaHandlerThread;",
...
static base::subtle::AtomicWord g_org_chromium_base_JavaHandlerThread_startAndInitialize = 0;
...
static base::subtle::AtomicWord g_org_chromium_base_JavaHandlerThread_stopOnThread = 0;
static void Java_JavaHandlerThread_stopOnThread(JNIEnv* env, const base::android::JavaRef<jobject>&
    obj, jlong nativeThread) {
  CHECK_CLAZZ(env, obj.obj(),
      org_chromium_base_JavaHandlerThread_clazz(env));
  jmethodID method_id = base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_INSTANCE>(
...
static base::subtle::AtomicWord g_org_chromium_base_JavaHandlerThread_joinThread = 0;
...
static void Java_JavaHandlerThread_stop(JNIEnv* env, const base::android::JavaRef<jobject>& obj,
    jlong nativeThread) {
  CHECK_CLAZZ(env, obj.obj(),
      org_chromium_base_JavaHandlerThread_clazz(env));
  jmethodID method_id = base::android::MethodID::LazyGet<
...
static base::subtle::AtomicWord g_org_chromium_base_JavaHandlerThread_isAlive = 0;
...
static base::subtle::AtomicWord
    g_org_chromium_base_JavaHandlerThread_listenForUncaughtExceptionsForTesting = 0;
...
static base::subtle::AtomicWord g_org_chromium_base_JavaHandlerThread_getUncaughtExceptionIfAny = 0;
