...
bool BaseChannel::ConnectToRtpTransport() {
  ...
  ALOGI("ppt, in BaseChannel::ConnectToRtpTransport, go to RegisterRtpDemuxerSink.\n");
...
bool BaseChannel::AddRecvStream(const StreamParams& sp) {
  ...
  ALOGI("ppt, in BaseChannel::AddRecvStream, go to AddRecvStream_w.\n");
...
void BaseChannel::OnRtpPacket(const webrtc::RtpPacketReceived& parsed_packet) {
  ...
  ALOGI("ppt, in BaseChannel::OnRtpPacket, go to OnRtcpReceived.\n");
...
bool BaseChannel::RegisterRtpDemuxerSink() {
  RTC_DCHECK(rtp_transport_);
  ALOGI("ppt, in BaseChannel::RegisterRtpDemuxerSink, go to rtp_transport_->RegisterRtpDemuxerSink, this: %p.\n", this);
...
void BaseChannel::OnRtcpPacketReceived(rtc::CopyOnWriteBuffer* packet,
  ...
  ALOGI("ppt, in BaseChannel::OnRtcpPacketReceived, go to OnRtcpReceived.\n");
...
void BaseChannel::OnPacketReceived(bool rtcp,
  ...
  ALOGI("ppt, in BaseChannel::OnPacketReceived, go to BaseChannel::ProcessPacket.\n");
...
void BaseChannel::ProcessPacket(bool rtcp,
  ...
  if (rtcp) {
  	ALOGI("ppt, in BaseChannel::ProcessPacket, go to OnRtcpReceived.\n");
    media_channel_->OnRtcpReceived(&data, packet_time);
  } else {
  	ALOGI("ppt, in BaseChannel::ProcessPacket, go to OnPacketReceived.\n");
...
bool BaseChannel::AddRecvStream_w(const StreamParams& sp) {
  ...
  ALOGI("ppt, in BaseChannel::AddRecvStream_w, go to AddRecvStream.\n");
...
bool BaseChannel::UpdateRemoteStreams_w(
  ...
  for (StreamParamsVec::const_iterator it = streams.begin();
    ...
    if ((!it->has_ssrcs() && !HasStreamWithNoSsrcs(remote_streams_)) ||
      ...
      ALOGI("ppt, in BaseChannel::UpdateRemoteStreams_w, go to AddRecvStream_w.\n");
  ...
  ALOGI("ppt, in BaseChannel::UpdateRemoteStreams_w, go to RegisterRtpDemuxerSink.\n");
...
bool VoiceChannel::SetLocalContent_w(const MediaContentDescription* content,
  ...
  ALOGI("ppt, in VoiceChannel::SetLocalContent_w 1, go to RegisterRtpDemuxerSink.\n");
  if (!RegisterRtpDemuxerSink()) {
...
bool VideoChannel::SetLocalContent_w(const MediaContentDescription* content,
  ...
  ALOGI("ppt, in BaseChannel::SetLocalContent_w 2, go to RegisterRtpDemuxerSink.\n");
  // Need to re-register the sink to update the handled payload.
  if (!RegisterRtpDemuxerSink()) {
...
void RtpDataChannel::Init_w(webrtc::RtpTransportInternal* rtp_transport) {
  RTC_LOG(LS_ERROR) << "ppt, in RtpDataChannel::Init_w, go to BaseChannel::Init_w";
...
bool RtpDataChannel::SetLocalContent_w(const MediaContentDescription* content,
  ...
  ALOGI("ppt, in RtpDataChannel::SetLocalContent_w, go to RegisterRtpDemuxerSink.\n");
  // Need to re-register the sink to update the handled payload.
  if (!RegisterRtpDemuxerSink()) {
